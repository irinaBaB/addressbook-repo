...
class Contact:
    ...
    def __repr__(self):
        return "%s:%s:%s:%s:%s:%s:%s:%s:%s:%s" % (self.id, self.lastname, self.firstname, self.email, self.email2, self.homephone, self.mobilephone,
                                            self.workphone, self.secondaryphone, self.all_phones_from_home_page)
